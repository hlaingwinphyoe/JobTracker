<button id="dropdownUserAvatarButton" data-dropdown-toggle="dropdownAvatar"
    ...
    <img src="https://ui-avatars.com/api/?size=40&rounded=true&name={{ Auth::guard('employer')->user()->name }}"
        alt="profile_img">
</button>
...
<div id="dropdownAvatar" class="z-10 hidden bg-white divide-y divide-gray-200 rounded-lg shadow w-44">
    <div class="px-4 py-3 text-sm text-secondary-500 text-center ">
        <span class="fw-bold text-lg">{{ Auth::guard('employer')->user()->name }}</span>
    </div>
    ...
    <div class="py-2">
        ...
        <form method="POST" action="{{ route('employer.logout') }}">
            ...
            <a href="{{ route('employer.logout') }}" class="block px-4 py-2 text-sm text-red-500 hover:bg-gray-100"
