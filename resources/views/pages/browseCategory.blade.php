    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <a href="#"
            ...
            <h5 class="text-3xl text-center font-semibold tracking-tight text-secondary-500">
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 via-primary-400 to-tertiary-500 ">
                    1200+
                </span> 
                <span class="text-2xl uppercase">Jobs</span>
            </h5>
            <x-primary-button name="Explore More" class="rounded-xl group">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-narrow-right ml-1 hidden group-hover:block"
