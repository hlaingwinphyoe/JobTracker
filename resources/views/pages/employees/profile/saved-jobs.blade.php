        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-gray-100 rounded-[24px] p-10 col-span-3 mt-5 lg:mt-0">
                ...
                <div class="relative mt-5">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center">
                                                <a href="{{ route('jobs.show', $job_post->slug) }}"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="icon icon-tabler icon-tabler-eye" width="18"
                    ...
                    <div class="paginate">
                        {{ $savedJobs->appends(request()->query->all())->links('composables.pagination') }}
                    </div>
                </div>
            </div>
        </div>
