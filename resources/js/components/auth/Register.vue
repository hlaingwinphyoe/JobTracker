<template>
  ...
  >
    ...
    >
      ...
      <div
        class="bg-white rounded-3xl md:p-4 z-50 md:m-4 relative h-auto md:min-h-fit w-full md:max-w-4xl"
      >
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    <input
                      ...
                      v-model="form.name"
                      type="text"
                      class="bg-transparent caret-gray-500 border text-sm border-gray-400 text-gray-500 rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5"
                  ...
                  <div>
                    ...
                    <div class="relative">
                      ...
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="icon icon-tabler icon-tabler-mail text-primary-500"
                          width="17"
                          height="17"
                          viewBox="0 0 24 24"
                          stroke-width="1.5"
                  ...
                  <div>
                    ...
                    <div class="relative">
                      ...
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="icon icon-tabler icon-tabler-phone text-primary-500"
                          width="17"
                          height="17"
                          viewBox="0 0 24 24"
                          stroke-width="1.5"
                  ...
                  <div>
                    ...
                    <div class="relative">
                      ...
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="icon icon-tabler icon-tabler-briefcase text-primary-500"
                          width="17"
                          height="17"
                          viewBox="0 0 24 24"
                          stroke-width="1.5"
                ...
                errors
                  ...
                  <div>
                    <label
                      for=""
                      class="block mb-2 text-sm font-medium text-gray-500"
                      >Company Type <span class="text-red-500">*</span></label
                    >
                    <div class="relative">
                      <div
                        class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none"
                      ...
                      >
                        ...
                        <option value="+95">🇲🇲&emsp;Myanmar (+95)</option>
                        <option value="+66">🇹🇭&emsp;Thai (+66)</option>
                      </select>
                    </div>
                    <!-- <span class="text-xs text-red-500">{{
                  errors.company Type
                  ...
                  <div>
                    ...
                    <div class="relative">
                      ...
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="icon icon-tabler icon-tabler-world text-primary-500"
                          width="17"
                          height="17"
                          viewBox="0 0 24 24"
                          stroke-width="1.5"
