<template>
  ...
  >
    <li class="mr-2">
      <a
        href="#"
        class="inline-block px-4 py-3 rounded-lg bg-primary-500 text-white hover:text-white"
        >All</a
      >
    </li>
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 2xl:grid-cols-4 gap-4 lg:gap-8">
